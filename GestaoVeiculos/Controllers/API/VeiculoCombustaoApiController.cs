...
namespace GestaoVeiculos.Controllers.API
{
    ...
    public class VeiculoCombustaoApiController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<VeiculoCombustaoResponseDTO>>> GetVeiculosCombustao()
        {
            var veiculos = await _veiculoCombustaoRepository.GetAllAsync();

            var responseDtos = veiculos.Select(veiculo => new VeiculoCombustaoResponseDTO
            {
        ...
        public async Task<IActionResult> PutVeiculoCombustao(int id, VeiculoCombustaoRequestDTO veiculoDTO)
        {
            try
            {
                ...
                var responseDto = new VeiculoCombustaoResponseDTO
                {
                    ...
                    Quilometragem_Mensal = (int)veiculoExistente.Quilometragem_Mensal,
                    Consumo_Medio = veiculoExistente.Consumo_Medio,
                    Autonomia_Tanque = (int)veiculoExistente.Autonomia_Tanque,
        ...
        private async Task<VeiculoCombustao> ValidarVeiculo(string marca, string modelo)
        {
            ...
            return veiculos.FirstOrDefault(v => v.Marca.Equals(marca, StringComparison.OrdinalIgnoreCase) && v.Modelo.Equals(modelo, StringComparison.OrdinalIgnoreCase));
        }
    }
}
